...
LoseScreen.prototype.screen_initialize = LoseScreen.prototype.initialize;
LoseScreen.prototype.initialize = function() {
    this.screen_initialize();


    this.add_label("The destiny is not fulfill!", new V(400, 50), new V(), 4000);
    ...
    setTimeout(function(){
        ...
        that.add_label("You lose",new V(600,250) , mt10, 4000);
    },1000);
...
LoseScreen.prototype.on_added_to_parent = function(parent) {
    Drawable.prototype.on_added_to_parent.call(this, parent);

};

LoseScreen.prototype.on_remove_from_parent = function(parent) {
    Drawable.prototype.on_remove_from_parent.call(this, parent);

};

LoseScreen.prototype.draw = function(context) {
...
LoseScreen.prototype.clear = function(context) {

};

LoseScreen.prototype.add_label = function(text, position, move_to, duration) {
...
LoseScreen.prototype.add_sprite = function(name, position, move_to, scale, z_index, duration) {
...
LoseScreen.prototype.add_rotating_sprite = function(name, position, move_to, scale, z_index, rotate, anchor, duration) {
