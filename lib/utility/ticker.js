        ...
        if (Ticker.is_started) {
            ...
            if (timestamp - Ticker.started_at > 1000) {
                ...
                if (Config.debug_info) {
                    game.debug_label.set({
                        text: "Window : " + Math.round(Config.canvas_width) + "x" + Math.round(Config.canvas_height) +
                                " | Screen : " + Config.device_width + "x" + Config.device_height +
                                " | FPS: " + Ticker.calculated_fps
                    });

                    game.debug_label2.set({
                        text: "Quality: " + (Config.is_low_resolution ? "low" : "high") +
                                " | Objects: " + game.stage.draw_objects +
