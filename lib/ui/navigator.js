(function (window, undefined) {
    ...
    Navigator.prototype.add = function (screen, animation_type, transition_callback, duration) {
        ...
        if (this.current_screen) {
            ...
            if (animation_type === Screen.ANIMATION_TYPE_FADEIN) {
            ...
            } else if (animation_type === Screen.ANIMATION_TYPE_SLIDE) {
            ...
            } else if (animation_type === Screen.ANIMATION_TYPE_SLIDEOVER) {
